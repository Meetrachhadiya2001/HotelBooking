...
export const OfferPage = () => {
  return (
    <div className="bg-white lg:bg-gradient-to-b lg:from-white lg:to-gray-300 mt-12 md:mt-16 lg:mt-24 mx-auto w-[75%] md:w-[70%] lg:w-full">
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        transition={{ delay: 0, duration: 1 }}
        viewport={{ once: false }}
        whileInView={{ opacity: 1, x: 0 }}
        className="flex flex-col gap-8 md:gap-12 lg:gap-20 w-full md:w-full lg:w-[70%] xl:w-[1320px] mx-auto"
      >
        <div className="flex flex-col gap-7">
          ...
          <p className="w-full md:w-9/12 lg:w-6/12 font-normal text-base md:text-lg lg:text-lg">
